...
Про личный архив я уже писал отдельно в статье ["Личный архив: сбор, бэкап, таймлайн фотографий"](../archive/2026-05-22%20Personal%20archive.md). Здесь задача понятная: обеспечить несколько копий, которые переживут поломку устройства, случайное удаление или физическую потерю.
...
Для копирования данных из источника в облака и офлайн-накопитель я использую `rclone`, который упоминал в [прошлой статье](../archive/2026-05-22%20Personal%20archive.md).
