...
Оценка здесь будет зависеть не только от разницы "я сейчас" и "я в новой роли", но и от доступного ресурса на ее покрытие. Например, смена стека требует времени и сил. С работой их не остается, а без работы нужен запас денег на жизнь. Поэтому такая цена для меня приемлема только если у меня достаточно накоплений.

## 2. Масштаб ответственности

Насколько мне подходит масштаб системы, продукта или направления, за которые я отвечаю.

CTO маленького стартапа и CTO крупной компании могут оба отвечать за всю технологическую часть, но масштаб этой ответственности будет разным. Он пропорционален количеству людей и вложенных денег, организационной и технологической сложности.
...
Например: задача интересная, продукт популярный, зарабатывает много, поэтому цена ошибки высокая, а код — легаси. Вдобавок HR-легаси — опытная команда, давно поделившая зоны ответственности. Формально я отвечаю за результат, а на деле любые инициативы будут упираться в негласные границы и чьи-то интересы.
...
Фиксированный график дает внешний организующий фактор, а свободный позволяет самому распределять время. Сюда же относятся гибкость начала и конца рабочего дня.

## Ожидание и реальность

До выхода на работу все эти оценки остаются прогнозом — в реальности ожидания могут не оправдаться как в одну, так и в другую сторону. Задачи окажутся легче, чем предполагалось, когда-то популярный продукт может оказаться на излете, а бюрократия  сделает время доставки неадекватным.

Кроме того, уже потом становится видно то, что заранее оценить невозможно: реальную нагрузку, рабочую среду, свое место в команде и перспективы. Поэтому после выхода добавляются еще несколько критериев.

Все эти критерии вместе я использовал как тимлид для диагностики членов команды. Фиксировал оценки раз в полгода и отслеживал динамику. Это позволило более предметно обсуждать вопрос удовлетворенности на тет-а-тетах.
...
Это не только про количество задач или номинальных рабочих часов. На нагрузку влияют темп, кранчи, частота переключений и фоновая неопределенность.

## 9. Удельный вес

Доля моего участия в общем результате.

Можно работать над популярным продуктом, иметь достаточный объем ответственности и полномочий, но оказаться на периферии. Важные задачи почему-то достаются другим, а мое мнение на обсуждениях аккуратно игнорируется. Бывает, наоборот: проект сам по себе небольшой, я вроде не главный, но от моих решений многое зависит.
...
Можно расширять стек или персональные зоны ответственности, брать другой тип задач. Речь тут не столько про карьерный рост. Вопрос в том, можно ли что-то поменять, если в какой-то момент нынешняя конфигурация перестанет устраивать или просто надоест.

## Реальный пример с последнего места работы

В финале приведу динамику моей удовлетворенности последним местом работы. Из неизменного оставались только жесткая привязка к офису и фиксированный график 9-18.

До тимлидства масштаб ответственности уже казался тесноватым. Но в целом устраивало: экспертизы и полномочий хватало, продукт был успешным, деньги и нагрузка — вполне норм.

Когда я только стал тимлидом, очевидно, менеджерской экспертизы не хватало, в некоторых технических вопросах были пробелы, а полномочия упирались в зависимость от легаси как в коде, так и в команде. Все это отразилось и на комфорте, и на нагрузке.

Уже позже, когда опыта стало достаточно, постепенно собралась новая команда, мы начали новый проект, удовлетворенность достигла максимума за все время работы там. Кроме привязки к офису и графика оставались еще два минуса: новый проект по независящим от нас причинам так и не дошел до глобального запуска, и перспектив для моего дальнейшего роста в компании уже не было.

<img src="imgs/table.jpg" width=500>
